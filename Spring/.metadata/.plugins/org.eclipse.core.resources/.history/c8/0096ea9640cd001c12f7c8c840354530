				...
				<div class="col-md-8 col-sm-12">
					<section class="form-section">
						<form action="insertuser" id="register-form"
							...
							<input type='hidden' name='id' value="${userObj.id!"f"}">
							...
							<div class="form-group">
								<label for="mobile">Mobile :</label> <input type="number"
									...
									placeholder="Please enter mobile number" value="${userObj.mobile!"hello"}">
							...
							<div class="form-group">
								<label for="">Email :</label> <input type="text"
									...
									placeholder="Please enter valid email" value="${userObj.email!"hello"}">
							...
							<div class="addresses">
								...
								<#list userObj.address as address>
								  <div class="form-group address-section">
										...
										<textarea class="form-control" rows="3" class="address"
											placeholder="Please enter Address" name="address.general" >${address.general!""}</textarea>
										<div class="add-style">
											<span> <select class="form-control" id="city${address?index!""}" name="address.city">
											...
											</span> <span> <select class="form-control" id="state${address?index!""}" name="address.state">
								...
								<#else>
									<div class="form-group address-section">
										...
										<div class="add-style">
											<span> <select class="form-control" name="address.city">
													<option value="not">Select City</option>
													<option value="Botad">Botad</option>
													<option value="Ahmedabad">Ahmedabad</option>
													<option value="Baroda">Baroda</option>
											...
											</span> <span> <select class="form-control" name="address.state">
													<option value="not">Select State</option>
													<option value="Gujarat">Gujarat</option>
													<option value="Rajasthan">Rajasthan</option>
													<option value="Madhyapradesh">Madhyapradesh</option>
