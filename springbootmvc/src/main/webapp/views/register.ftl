							...
							<div class="addresses">
								...
								<#list userObj.address![] as address>
								  <div class="form-group address-section">
										...
										<div class="add-style">
											<span> <select class="form-control" id="city${address?index!""}" name="address[${address?index!""}].city">
											...
											</span> <span> <select class="form-control" id="state${address?index!""}" name="address[${address?index!""}].state">
												...
												class="form-control" name="address[${address?index!""}].pincode"
								...
								<#else>
									<div class="form-group address-section">
										...
										<div class="add-style">
											<span> <select class="form-control" name="address[0].city">
													<option value="not">Select City</option>
													<option value="Botad">Botad</option>
													<option value="Ahmedabad">Ahmedabad</option>
													<option value="Baroda">Baroda</option>
											...
											</span> <span> <select class="form-control" name="address[0].state">
													<option value="not">Select State</option>
													<option value="Gujarat">Gujarat</option>
													<option value="Rajasthan">Rajasthan</option>
													<option value="Madhyapradesh">Madhyapradesh</option>
												...
												class="form-control" name="address[0].pincode"
...
<!--	<script src="./resources/javascript/custom.js"></script>-->
	...
	/* Below function add preview image after user add some image */	
			$('#imageclick').change(function(){
		        ...
		        console.log("hello i am from image change");
		        if (file){
		  ...
		  function dropCheck(dropval,errorField){
			...
			function emailCheck(fValue,errorField){
				...
				if(nullCheck(fValue,errorField) && !regex.test(fValue)){
					...
					if(fValue != "${userObj.email!"pradip"}"){
						$.ajax({
							url : "EmailCheck",
							type : "post",
							data : {
